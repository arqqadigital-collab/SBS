...
const features = [
  ...
  { icon: ClipboardList, title: "Automated Charge Capture", body: "Every billable event — procedures, medications, investigations, bed days — flows from the clinical record to billing without manual entry. Missed-charge detection identifies documentation that suggests a billable service was delivered but not captured." },
  { icon: FileText, title: "Coding & Code Optimization", body: "ICD-10, CPT, and DRG coding with NLP-assisted code suggestions from clinical documentation. Coders work from a structured interface with codes, guidelines, and the clinical record side by side. Coding accuracy tracked by coder, department, and service line." },
  { icon: ShieldCheck, title: "Pre-Submission Claim Validation", body: "Every claim passes through a validation engine checking for missing fields, invalid combinations, authorization mismatches, and known payer-specific denial triggers. Only clean claims reach the payer. First-pass acceptance rates improve immediately." },
  { icon: Send, title: "Multi-Payer Electronic Submission", body: "Claims submitted electronically to insurance companies, government programs, self-pay, and corporate accounts through certified channels. NPHIES (KSA), DHA eClaims (Dubai), and DOH (Abu Dhabi) integrations included. Paper claims eliminated." },
  { icon: AlertTriangle, title: "Denial Management & Appeals", body: "Denied claims are captured, categorized by reason, and routed automatically. Appeal letters are generated from configurable templates with clinical documentation and authorization evidence attached. Appeal deadlines are tracked and escalated before windows close." },
  { icon: Banknote, title: "Remittance & Underpayment Recovery", body: "Electronic remittance is processed automatically — payments matched, adjustments categorized, contractual allowances applied. Actual payer payments are compared against contracted rates to flag systematic underpayments that would otherwise go undetected." },
  { icon: CreditCard, title: "Patient Financial Services", body: "Patient liability is calculated at the point of service. Payment plans are offered and documented digitally. Automated statements and structured collections workflows balance revenue recovery with patient financial experience." },
  { icon: BarChart3, title: "Real-Time Executive Dashboards", body: "Live dashboards for gross charges, net collections, days in A/R, denial rates by payer and reason, first-pass acceptance, and cash flow forecasts. Problems are identified and acted on the week they emerge — not the month after." },
  { icon: Receipt, title: "Contract & Payer Performance", body: "Manage every payer contract — fee schedules, reimbursement rates, bundled payments, capitation. Performance analytics show what each payer is actually paying versus what was contracted, exposing underpayments and informing renegotiation." },
  { icon: Wallet, title: "ZATCA & National Platform Compliance", body: "Native ZATCA Phase 2 e-invoicing for Saudi Arabia: every invoice formatted to Fatoora specifications, cryptographically stamped, and cleared in real time. NPHIES, DHA, and DOH submission pathways pre-configured." },
];

const journey = [
  { icon: UserCheck, title: "Registration & Eligibility", image: rcmJourney1, body: "The patient registers. Insurance eligibility is verified in real time. Coverage, authorization requirements, and patient liability are confirmed before the first clinical interaction." },
  { icon: FileCheck2, title: "Authorization", image: rcmJourney2, body: "Clinical orders requiring pre-authorization trigger automatic requests. Status is tracked through approval. Services are scheduled only when authorization is confirmed." },
  { icon: Stethoscope, title: "Care Delivered & Charges Captured", image: rcmJourney3, body: "Every billable service — procedures, medications, investigations, bed days — is captured automatically from the clinical record. No manual charge entry. No missed charges." },
  { icon: FileText, title: "Coding & Claim Generation", image: rcmJourney4, body: "Clinical documentation drives coding suggestions. Coders review, optimize, and finalize codes. Claims are generated automatically and pass through pre-submission validation." },
  { icon: Send, title: "Submission & Tracking", image: rcmJourney5, body: "Claims submitted electronically to the correct payer through the correct channel. Status is tracked in real time. Approaching deadlines trigger automatic follow-up." },
  { icon: Banknote, title: "Payment, Denials & Reconciliation", image: rcmJourney6, body: "Payments are matched to claims automatically. Underpayments are flagged. Denials are categorized and routed for appeal with documentation attached. The revenue cycle closes completely." },
];
        ...
        <div className="sticky top-0 flex min-h-screen flex-col overflow-hidden">
          <div className="mx-auto w-full max-w-7xl px-6 pt-14 md:px-12 md:pt-16">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-relaxed text-white/65 md:text-base">
              Not because of poor clinical quality — but because of claim errors, missed charges, expired
              authorizations, and reactive denial management that can't keep pace with payer complexity.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-relaxed text-foreground/70 md:text-lg">
              Every function of the revenue cycle, connected and automated — from the front desk to the final dollar
              collected.
            </p>
          </div>
      ...
      <section className="relative overflow-hidden px-6 py-24 md:px-12" style={{ backgroundColor: "#091628" }}>
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <p className="mx-auto mt-12 max-w-3xl text-center text-sm text-white/70 md:text-base">
            9% average charge leakage identified and recovered in the first 90 days of automated charge capture
            deployment. 100% of underpayment variances above threshold flagged automatically for payer audit.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-24 md:px-12">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-base leading-relaxed text-foreground/70 md:text-lg">
            Secreta RCM connects with your clinical systems, national health platforms, payer portals, and financial
            management infrastructure — creating a revenue cycle that flows automatically from clinical activity to
            collected cash, without manual bridges between disconnected systems.
          </p>
      ...
      >
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mt-8 text-lg leading-relaxed text-white/80">
            Your clinical teams work too hard and your patients receive too much value for your revenue cycle to be
            the place where that value leaks away. That ends today.
          </p>
